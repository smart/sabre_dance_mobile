...
require 'lib/facebooker/attachment'
require 'lib/facebooker/batch_request'
require 'lib/facebooker/feed'
require 'lib/facebooker/logging'
require 'lib/facebooker/model'
require 'lib/facebooker/parser'
require 'lib/facebooker/service'
require 'lib/facebooker/service/base_service'
#optional HTTP service adapters
begin
  require 'lib/facebooker/service/curl_service'
rescue LoadError
  nil
end
begin
  require 'lib/facebooker/service/typhoeus_service'
  require 'lib/facebooker/service/typhoeus_multi_service'
rescue LoadError
  nil
end

require 'lib/facebooker/service/net_http_service'
require 'lib/facebooker/server_cache'
require 'lib/facebooker/data'
require 'lib/facebooker/admin'
require 'lib/facebooker/application'
require 'lib/facebooker/mobile'
require 'lib/facebooker/session'
require 'lib/facebooker/stream_post'
require 'lib/facebooker/version'
require 'lib/facebooker/models/location'
require 'lib/facebooker/models/affiliation'
require 'lib/facebooker/models/album'
require 'lib/facebooker/models/comment'
require 'lib/facebooker/models/education_info'
require 'lib/facebooker/models/work_info'
require 'lib/facebooker/models/event'
require 'lib/facebooker/models/group'
require 'lib/facebooker/models/notifications'
require 'lib/facebooker/models/page'
require 'lib/facebooker/models/photo'
require 'lib/facebooker/models/cookie'
require 'lib/facebooker/models/applicationproperties'
require 'lib/facebooker/models/applicationrestrictions'
require 'lib/facebooker/models/tag'
require 'lib/facebooker/models/user'
require 'lib/facebooker/models/info_item'
require 'lib/facebooker/models/info_section'
require 'lib/facebooker/models/friend_list'
require 'lib/facebooker/models/video'
require 'lib/facebooker/models/message_thread'
require 'lib/facebooker/adapters/adapter_base'
require 'lib/facebooker/adapters/facebook_adapter'
require 'lib/facebooker/adapters/bebo_adapter'
