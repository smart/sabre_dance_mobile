...
I fully understand your apprehension about such a change to the core. 
Here is an example of how a developer could implement a page loader.
...
This would allow an app to jump to the requested page on initial load, enabling the user to bookmark your page, 
or use the back button from an outside resource in order to return to the last page they visited on a site.

Got any suggestions how this might be improved?
